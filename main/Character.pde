class Character {
  ...
  void posCheck() {
    if (this.posX - this.sizeX/2.0f < 0.0f + ERROR) {
      this.posX = this.sizeX/2.0f;
      this.wanderX = 1;
    } else if (this.posX + this.sizeX/2.0f > width - ERROR) {
      this.posX = width - this.sizeX/2.0f;
      this.wanderX = -1;
    }
    if (this.posY - this.sizeY/2.0f < 0.0f + ERROR) {
      this.posY = this.sizeY/2.0f;
      this.wanderY = 1;
    } else if (this.posY + this.sizeY/2.0f > height - ERROR) {
      this.posY = height - this.sizeY/2.0f;
      this.wanderX = -1;
    }
